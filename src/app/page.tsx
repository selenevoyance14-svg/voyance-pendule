...
import EnergieDuJour from "./components/EnergieDuJour";
        ...
        <>
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
                    ...
                    {/* Énergie du jour — change chaque jour */}
                    <EnergieDuJour />

                    {/* Pendulum visual — crystal mystique animé */}
                    <div className="mt-16 flex justify-center">
                        <div className="relative w-64 h-72">
                            {/* Aura halo qui pulse */}
                            <div className="absolute bottom-14 left-1/2 -translate-x-1/2 w-44 h-44 rounded-full bg-gradient-to-br from-mystic-500/30 via-mystic-400/20 to-gold-400/20 blur-3xl animate-glow" />

                            {/* Cercle ésotérique tournant */}
                            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-48 h-48 rounded-full border border-mystic-500/15 animate-spin-slow" />
                            <div className="absolute bottom-14 left-1/2 -translate-x-1/2 w-32 h-32 rounded-full border border-gold-500/15 animate-spin-slow" style={{ animationDirection: "reverse", animationDuration: "30s" }} />

                            {/* Point d'ancrage doré */}
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-gold-400 shadow-[0_0_15px_rgba(212,160,23,0.9)] z-20" />

                            {/* Pendule (oscille) */}
                            <div className="pendulum absolute top-2 left-1/2 -translate-x-1/2 origin-top flex flex-col items-center">
                                {/* Chaîne dorée */}
                                <div className="w-px h-44 bg-gradient-to-b from-gold-400/70 via-gold-500 to-gold-400" />

                                {/* Cristal facetté */}
                                <div className="relative -mt-1">
                                    <div
                                        className="w-10 h-16 bg-gradient-to-b from-mystic-200 via-mystic-500 to-mystic-800 shadow-[0_0_35px_rgba(139,76,252,0.7)] animate-glow"
                                        style={{ clipPath: "polygon(50% 0%, 100% 28%, 88% 100%, 12% 100%, 0% 28%)" }}
                                    />
                                    {/* Reflet brillant */}
                                    <div className="absolute top-2 left-[10px] w-3 h-2 rounded-full bg-white/60 blur-[1px]" />
                                    <div className="absolute top-5 left-[14px] w-1 h-3 bg-white/30 blur-[0.5px]" />
                                </div>
                            </div>

                            {/* Étincelles flottantes */}
                            <span className="absolute top-8 left-2 text-gold-400 text-xl animate-twinkle">✦</span>
                            <span className="absolute top-20 right-1 text-mystic-300 animate-twinkle" style={{ animationDelay: "0.7s" }}>✧</span>
                            <span className="absolute bottom-28 left-0 text-gold-400 text-sm animate-twinkle" style={{ animationDelay: "1.4s" }}>✦</span>
                            <span className="absolute bottom-20 right-4 text-mystic-300 text-lg animate-twinkle" style={{ animationDelay: "0.3s" }}>✧</span>
                            <span className="absolute top-32 left-6 text-gold-300 text-xs animate-twinkle" style={{ animationDelay: "2s" }}>✦</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="relative py-20 sm:py-28 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-b from-mystic-950/40 via-[#2a1a3a] to-mystic-950/40" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <ScrollReveal delay={0}>
                            <a href="/tirage" className="gold-card p-8 text-center block h-full">
                        ...
                        <ScrollReveal delay={120}>
                            <a href="/pendule-gratuit" className="glass-card p-8 text-center block h-full">
                        ...
                        <ScrollReveal delay={240}>
                            <a href="/horoscope" className="glass-card p-8 text-center block h-full">
                                <div className="text-5xl mb-6">♈</div>
                        ...
                        <ScrollReveal delay={360}>
                            <a href="/message-ange" className="glass-card p-8 text-center block h-full">
                                <div className="text-5xl mb-6">👼</div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-4 sm:gap-6">
                        {zodiacSigns.map((z, idx) => (
                            <ScrollReveal key={z.sign} delay={idx * 50}>
                                <a
                                    href="/horoscope"
                                    className="glass-card p-4 text-center group block h-full"
                                >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {latestPosts.map((post, idx) => (
                            <ScrollReveal key={post.slug} delay={idx * 120}>
                                <a
                                    href={`/blog/${post.slug}`}
                                    className="glass-card flex flex-col group hover:border-mystic-500/50 transition-all duration-300 h-full"
                                >
                                    <div className="h-32 bg-mystic-900/50 flex items-center justify-center overflow-hidden">
                                        <img
                                            src={post.image}
                                            alt={post.title}
